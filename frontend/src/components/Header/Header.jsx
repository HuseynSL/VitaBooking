        ...
        <div className="header w-full bg-yellow-500">
            <div className={style.container}>
                ...
                <div className="headerList flex gap-5 text-white text-">
                    <div className="headerListItem flex gap-2 border-2 rounded-full p-2 text-md">
                        <span className='pt-1'><IoBed /></span>
                        <span>Stays</span>
                    </div>
                    <div className="headerListItem flex gap-2 p-2 text-md">
                        <span className='pt-1'><MdFlightTakeoff /></span>
                        <span>Flight</span>
                    </div><div className="headerListItem flex gap-2 p-2 text-md">
                        <span className='pt-1'><FaCar /></span>
                        <span>Car</span>
                    </div><div className="headerListItem flex gap-2 p-2 text-md">
                        <span className='pt-1'><MdAttractions /></span>
                        <span>Attractions</span>
                    </div><div className="headerListItem flex gap-2 p-2 text-md">
                        <span className='pt-1'><BsFillTaxiFrontFill /></span>
            ...
            <div className="headerSearch w-full flex justify-around py-10 rounded-xl absolute h-8 bg-white border-2 border-blue-500  bottom-[-30px] pt-8">
              ...
              <div className="headerSearchItem flex items-center gap-5">
                <span className='headerIcon'><IoIosBed /></span>
                <input
                  type="text"
                ...
                {/* date */}
              <div className="headerSearchItem flex items-center gap-5">
              <span className='headerIcon'><FaCalendarAlt /></span>
                <span
                ...
                {/* people */}
              <div className="headerSearchItem flex items-center gap-5">
              <span className='headerIcon'><IoPersonOutline /></span>
                <span
                  onClick={() => setOpenOptions(!openOptions)}
                  className="headerSearchText text-gray-500 cursor-pointer"
                >{`${options.adult} adult · ${options.children} children · ${options.room} room`}</span>
                {openOptions && (
                  <div className="options z-10 absolute top-[50px] bg-white text-gray border-4 shadow-[0px_0px_10px_-5px_rgba(0,0,0,0.4)]">
                ...
                {/* button */}
              <div className="headerSearchItem flex items-center gap-5">
                <button className="headerBtn p-2 rounded-md bg-yellow-500" >
                  Search
                </button>
              </div>
            </div>
